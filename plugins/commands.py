# Don't Remove Credit Tg - @The_hell_king_movie_group
...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [
            ...
            #],
            [
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/TheHellKingSupport'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/the_hell_king_updates')
            ],
...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        try:
            ...
            title = 'ℍℍ𝕖𝕝𝕝𝕠 𝔽𝕣𝕚𝕖𝕟𝕕 ℍ𝕖𝕣𝕖𝕖 𝕀𝕤 𝕐𝕠𝕦𝕣 𝔽𝕚𝕝𝕖𝕤/𝕍𝕚𝕕𝕖𝕠𝕤/𝕊𝕠𝕟𝕘𝕤 ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
