...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [
            ...
            #],
            #[InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/TheHellKingSupport'),InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/the_hell_king_updates')],
...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        try:
            ...
            title = '🙋 Hello Friend Here Is Your Files/Videos/Audios ⬎\n\n' + '            '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
